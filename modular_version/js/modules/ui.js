...
function updateVisitorCount() {
    ...
    const elem = document.getElementById('visitorCount');
    if (elem) elem.innerText = count;
}
function updatePharmacyCount(count) {
    const elem = document.getElementById('pharmacyCount');
    if (elem) elem.innerText = count || '0';
}
function updateMarketCount(count) {
    const elem = document.getElementById('marketCount');
    if (elem) elem.innerText = count || '0';
}
